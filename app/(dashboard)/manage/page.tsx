  ...
  return (
    <>
      <div className="border-b bg-card">
        <div className="container mx-auto max-w=[1440px] flex flex-wrap items-center justify-between gap-6 py-8">
          <div>
    ...
    <>
      <SkeletonWrapper isLoading={categoryQuery.isLoading}>
        <Card>
          ...
          {dataAvailable && (
            <div
              className="grid grid-flow-row gap-2 p-2 sm:grid-flex-row sm:grid-cols-2
